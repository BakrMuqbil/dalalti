...
export default function AdminPlansPage() {
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      setMessage(data.message || "تم تحديث الباقة");
      reset(); await load();
    } catch (e) { setError(e instanceof Error ? e.message : "حدث خطأ"); }
