  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        {" "}
        <div className="flex flex-1 items-center gap-2 rounded-xl border border-line bg-surface px-3 py-2 min-w-[200px]">
          {" "}
        ...
        {hasActiveFilters && (
          <button
            ...
            className="rounded-lg border border-line px-3 py-2 text-xs font-semibold text-ink-soft hover:bg-background"
          >
            {" "}
            مسح الفلاتر{" "}
          </button>
      ...
      {loading && products.length === 0 ? (
        ...
        <>
          ...
          <ProductsTable
            ...
            onRefresh={() => void loadProducts(page)}
      ...
      {pagination.pages > 1 && (
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-xl border border-line bg-surface px-4 py-2 text-sm font-medium text-ink-soft transition hover:bg-background disabled:opacity-40"
          >
            {" "}
            <ChevronRightIcon width={14} height={14} /> السابق{" "}
          </button>{" "}
          ...
          >
            {" "}
            التالي <ChevronLeftIcon width={14} height={14} />{" "}
          </button>{" "}
        </div>
      )}{" "}
